        ...
        <div className="container pt-4 pb-2">
          <div className="col-md-10 col-lg-6 mt-3 border shadow rounded mx-auto">
            {post.image !== null && (
              <div className="row">
                <div
                  className="text-center border shadow-sm mt-4 mt-md-5 mb-3 col-10 mx-auto"
                  id="postImage"
                >
                  {newImage && (
                    <div className="d-flex justify-content-center my-4">
                      <img
                        className="text-center w-75 ms-4"
                        alt="not fount"
                  ...
                  {!newImage && (
                    <div className="row">
                      <div
                        className="text-center shadow-sm p-0 col-12 mx-auto"
                        id="postImage"
                      >
                        <PostImage
                          src={post.image}
            ...
            {post.image !== null && (
              <>
                {!newImage && (
                  <div className="row">
                    <label className="btn link-secondary my-1 col-8 mx-auto">
                      <AddImage
                        type="file"
                        name="myImage"
                        onChange={(event) => {
            ...
            <div className="row">
              <button
                className="btn btn-light border border-2 mb-4 mt-2 col-6 mx-auto"
...
//               <div className="row">
//                 <div
//                   className="text-center border shadow-sm mt-4 mb-3 col-10 mx-auto"
//                   id="postImage"
//                 >
//                   {newImage && (
